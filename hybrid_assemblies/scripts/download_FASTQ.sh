...
fastq-dump --split-files --outdir $sample_out_dir $run_ID

FQ1_fName="$sample_out_dir/SR.R1.fastq"
FQ2_fName="$sample_out_dir/SR.R2.fastq"

mv "$sample_out_dir/${run_ID}_1.fastq" "$sample_out_dir/SR.R1.fastq"
mv "$sample_out_dir/${run_ID}_2.fastq" "$sample_out_dir/SR.R2.fastq"
...
gzip "$sample_out_dir/SR.R1.fastq"
gzip "$sample_out_dir/SR.R2.fastq"