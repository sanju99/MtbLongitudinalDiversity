...
def plotHist(outputDir, originalFreqVecFlat,  freqVecFlat, gmm, figureFileName):
    ...
    axs[0].set_yscale('log', base=2, nonpos='clip')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', metavar='ref', dest='ref', help='Genome reference. It is highly recommended to use the default reference file for compatibility with the GFF file.', default='tuberculosis.fna')
    parser.add_argument('-b', metavar='gff', dest='gff', help='Use gff file to process only gff regions. It is highly recommended to use the default GFF file as it takes care of problematic genomic regions.', default='tuberculosis.filtered-intervals.gff')
    ...
    parser.add_argument('-fd', metavar='n', required=False, default=75, dest='depthThreshold', type=int, help='Do not consider pileup columns with the depth percentage less than n percent. Setting this to 75 means ignore sites with depth coverage less than 75% of the bam avg depth. Default=75.')
